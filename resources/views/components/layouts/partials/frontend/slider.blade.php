...
<div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item <?=$active?>">
                <img src="{{asset('assets/img').'/'. $slider->src}}" class="d-block w-100" alt="<?=$slider->alt?>">
                    <div class="carousel-caption ">
                        <h5 style="color: rgb(0, 0, 0);"><?=$slider->title ?></h5>
                        <p style="color: rgb(0, 0, 0);"><?=$slider->description ?></p>
                    </div>
            </div>
          <?php
          endforeach
